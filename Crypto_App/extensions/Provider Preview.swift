   ...
   @MainActor  init(){
        do {
             container = try ModelContainer(for : CoinData.self)
                ...
                HomeVm =  HomeViewModel(modelContext: container.mainContext)
    ...
    let state1 = Statistic(title: "Market Cap", value: "12.5Bn", percentagechange: 25.34)
    let state2 = Statistic(title: "Total volume", value: "15.3Tr ")
    let state3 = Statistic(title: "Portfolio view", value: "50.7k", percentagechange: -25.34)
